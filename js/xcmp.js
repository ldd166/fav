...
function play(play_id){
	...
	if(get_id[0]=='web'){
		window.top.frames['play'].location.href='web/'+get_id[1]+'.htm';
                 ...
                 window.top.frames['play'].location.href='http://10yy.win/blog/post-/'+get_id[1]+'.html';
        }else if(get_id[0]=='yk'){
                 window.top.frames['play'].location.href='http://10yy.win/s/?url=http://v.youku.com/v_show/id_'+get_id[1]+'.html';
        }else if(get_id[0]=='ol'){
                 window.top.frames['play'].location.href='http://10yy.win/v.php?id='+get_id[1];
        }else if(get_id[0]=='qy'){
                 ...
                 window.top.frames['play'].location.href='https://yuboyun.com/v/'+get_id[1];     
	}else if(get_id[0]=='tv'){
		window.top.frames['play'].location.href='play.htm?'+get_id[1];
        }else{
